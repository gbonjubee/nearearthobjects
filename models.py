...
class NearEarthObject:
    ...
    def to_json(self):
        """
        Convert NearEarthObject to formatted .json..
...
class CloseApproach:
    ...
    approach toEarth, such as the date and time (in UTC) of closest
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the
        # __repr__ method for examples of advanced string formatting.
        return f"At {self.time_str!r}, {self.neo!r} approaches Earth at a " \
               f"distance of {self.distance:.2f} au and a " \
    ...
    def to_json(self):
        """Convert CloseApproach to formatted .json.

        Formats CloseApproach to a dictionary mapping the keys
        'datetime_utc', 'distance_au', 'velocity_km_s' to the associated
        values on the CloseApproach object and the key neo to a dictionary
        mapping the keys 'designation', 'name', 'diameter_km',
        'potentially_hazardous' to the associated values on the close
        approach's NEO.
    ...
    def to_csv(self):
        ...
        The header columns are : 'datetime_utc', 'distance_au',
        'velocity_km_s', 'designation', 'name', 'diameter_km',
        'potentially_hazardous' - A missing name is represented as empty
        string - A missing diameter is represented as the string 'nan'. -
        The potentially_hazardous flag is represented the string 'False' or
        'True'.
        """
        return {
            "datetime_utc": self.time_str,
