...
There are a plethora of ways to combine the arguments to `create_filters`,
which correspond to different command-line options. This modules tests the
options in isolation, in pairs, and in more complicated combinations.
Althought the tests are not entirely exhaustive, any implementation that
passes all of these tests is most likely up to snuff.
...
class TestQuery(unittest.TestCase):
    ...
    def test_query_all(self):
        ...
        self.assertEqual(expected, received, msg="Computed results do not "
    ...
    def test_query_with_bounds_and_a_specific_date(self):
        ...
        filters = create_filters(date=date, start_date=start_date,
                                 end_date=end_date)
        received = set(self.db.query(filters))
        self.assertEqual(expected, received, msg="Computed results do not "
                                                 "match expected results.")
    ...
    def test_query_approaches_in_march_with_min_and_max_distance(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 3, 31)
        distance_max = 0.4
        distance_min = 0.1
    ...
    def test_query_approaches_in_march_with_distance_and_max_velocity(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 3, 31)
        distance_max = 0.4
        distance_min = 0.1
    ...
    def test_approaches_with_distance_velocity_and_max_diameter(self):
        start_date = datetime.date(2020, 3, 1)
    ...
    def test_approaches_with_distance_velocity_and_diameter_bounds(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
        distance_min = 0.05
    ...
    def test_approaches_in_spring_with_all_bounds_and_hazardous_neos(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
        distance_min = 0.05
    ...
    def test_approaches_with_all_bounds_and_not_hazardous_neos(self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
        distance_min = 0.05
