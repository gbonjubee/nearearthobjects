...
def cd_to_datetime(calendar_date):
    ...
    This will become the Python object `datetime.datetime(2020, 12, 31, 12,
    0)`.
...
def datetime_to_str(dt):
    ...
    however, our data isn't that precise, so this function only formats the
    year, month, date, hour, and minute values. Additionally, this function
